...
// // const remoteEntry =
// //   'MobileInventory@http://lois-10-mobileinventory-zephyr-repack-example-zep-1d1b5315b-ze.zephyr.local/mf-manifest.json';

// const remoteEntry = `@http://localhost:9001/${Platform.OS}/mf-manifest.json`;
